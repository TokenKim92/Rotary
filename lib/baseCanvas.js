export default class BaseCanvas {
  ...
  resize(width = 0, height = 0) {
    const vw = Math.max(document.documentElement.clientWidth || 0, window.outerWidth || 0); // prettier-ignore
    const vh = Math.max(document.documentElement.clientHeight || 0, window.outerHeight || 0); // prettier-ignore
